...
// ============================================
// Hiển thị danh sách phiên bản kế hoạch: Budget, Forecast, Actual.
// Cho phép: thêm/sửa/xóa, khóa/mở phiên bản, đặt mặc định.
//
...
import { PhienBan, LoaiPhienBan, PhienBanTaoMoi } from '../../../../core/models/phien-ban.model';
import { PhienBanService } from '../../services/phien-ban.service';
...
export class QuanLyPhienBanComponent implements OnInit {
    ...
    tenLoai(loai: LoaiPhienBan): string {
        return { 'KE_HOACH': 'Kế hoạch', 'DU_BAO': 'Dự báo', 'THUC_HIEN': 'Thực hiện' }[loai] || loai;
    }
