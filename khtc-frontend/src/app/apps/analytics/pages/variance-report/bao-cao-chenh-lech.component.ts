...
export class BaoCaoChenhLechComponent implements OnInit {
    ...
    /** Tạo dữ li�!u mock so sánh Plan vs Actual */
    private taoMockVariance(): void {
        const mockRows: VarianceRow[] = [
            { maChiTieu: 'DT', tenChiTieu: 'Doanh thu bán �i�!n', cap: 0, keHoach: 125430, thucHien: 118920, chenhLech: -6510, tyLe: -5.19 },
            ...
            { maChiTieu: 'CP_MUA', tenChiTieu: 'Chi phí mua �i�!n', cap: 1, keHoach: 72000, thucHien: 70100, chenhLech: -1900, tyLe: -2.64 },
            ...
            { maChiTieu: 'LN', tenChiTieu: 'Lợi nhuận trư�:c thuế', cap: 0, keHoach: 26680, thucHien: 23520, chenhLech: -3160, tyLe: -11.84 },
